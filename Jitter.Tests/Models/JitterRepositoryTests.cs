...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        public void JitterRepositoryEnsureIcanSearchByName()
        {
            ...
            List<JitterUser> actual_users =  repository.SearchByName(searchTerm);
        ...
        public void JitterRepositoryEnsureIcanGetAllJots()
        {
            ...
            List<Jot> expected_jots = new List<Jot>
            {
                ...
                new Jot { Content = "Sweeit Potato Pies >>>>> Punpkin Pies", Date =  base_time.AddHours(-1) }
            };
            ...
            Assert.AreEqual("Hello World", expected_jots[0].Content);
        }

        [TestMethod]
        public void JitterRepositoryEnsureICanCreateJot()
        {
            // Arrange
            DateTime base_time = DateTime.Now;
            List<Jot> expected_jots = new List<Jot>();
